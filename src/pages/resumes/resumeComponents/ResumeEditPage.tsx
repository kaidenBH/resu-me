...
import { useEducation, useEmployment, useLink, useSkill, useLanguage, useInternShip, useCourse, useCustom } from '../../../components/hooks';
          ...
          <Grid container sx={{ marginTop:'10rem', display: 'flex', justifyContent: 'center' }}>
            ...
            <Grid item xs={6} sx={{ marginTop: '3rem', marginBottom: '5rem' }}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                    <LinkTypography onClick={handleAddCustom}>+ Add Custom Section</LinkTypography>
                </Grid>
              </Grid>
            </Grid>
          </Grid>
